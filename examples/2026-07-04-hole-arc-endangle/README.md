...
| `regression_compare.md` | `parametric-regression` | **如何对比** + 本例对比结果说明 |
| `comparison_report.example.json` | `parametric-regression` | 本例示意 `comparison_report`（全 SAME + endAngle 专有验证） |
